...
if HostName.startswith('hancock'): # MONK
	# Local
	DEBUG = True
...
# cf. https://django-debug-toolbar.readthedocs.io/en/stable/configuration.html
# default = '//ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js'
# DEBUG_TOOLBAR_CONFIG = {'JQUERY_URL': '' } # rely on a version of jQuery that already exists on every page of your site
